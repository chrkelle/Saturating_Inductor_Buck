...
HD_PWD='C:/Users/cuixf/Documents/GitHub/Saturating_Inductor_Buck/Saturating_Inductor_Buck.runs/sc_counter_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sc_counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sc_counter.tcl
