...
HD_PWD='C:/Users/Chris/Desktop/Research/Saturating_Inductor_Buck/Saturating_Inductor_Buck.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ACD_gain_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ACD_gain_test.tcl -notrace
